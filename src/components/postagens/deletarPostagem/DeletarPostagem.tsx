    ...
    <div className='container w-1/3 mx-auto'>
      ...
      <div className='border flex flex-col rounded-2xl overflow-hidden justify-between'>
        ...
        <div className="flex">
          ...
          <button className='my-4 mx-14 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-10 border border-blue-500 hover:border-transparent rounded' onClick={deletarPostagem}>
            Sim
          </button>
        </div>
      </div>
